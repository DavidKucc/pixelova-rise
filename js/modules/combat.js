console.log('[DEBUG] combat.js loaded v=215');

import { gameState } from './state.js?v=215';
import { removeExpedition } from './game.js?v=215';
import { syncExpeditionToFirebase, removeExpeditionFromFirebase } from './multiplayer.js?v=215';
