...
console.log('[INPUT] input.js loaded v=145');

import { ui, updateSliderLabel, logMessage, removeContextMenu } from './ui.js?v=145';
import { viewportState, gameState } from './state.js?v=145';
import * as C from './config.js?v=145';
import { gatherExpeditions, launchExpedition, redirectExpedition, initGame, handleCellClick, captureStructure, showExpeditionMenu, showBuildMenu, showCaptureMenu, splitExpedition } from './game.js?v=145';
