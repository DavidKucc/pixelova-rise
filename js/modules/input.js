...
console.log('[INPUT] input.js loaded v=182');

import { ui, updateSliderLabel, logMessage, removeContextMenu } from './ui.js?v=182';
import { viewportState, gameState } from './state.js?v=182';
import * as C from './config.js?v=182';
import { gatherExpeditions, launchExpedition, redirectExpedition, initGame, handleCellClick, captureStructure, showExpeditionMenu, showBuildMenu, showCaptureMenu, splitExpedition } from './game.js?v=182';
import { updateUI } from './ui.js?v=182';
