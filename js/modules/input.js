console.log('[INPUT] input.js loaded v=213');

import { ui, updateSliderLabel, logMessage, removeContextMenu } from './ui.js?v=213';
import { viewportState, gameState } from './state.js?v=213';
import * as C from './config.js?v=213';
import { gatherExpeditions, launchExpedition, redirectExpedition, initGame, handleCellClick, captureStructure, showExpeditionMenu, showBuildMenu, showCaptureMenu, splitExpedition, centerCameraOnBase } from './game.js?v=213';
import { updateUI } from './ui.js?v=213';
            ...
            player.activeExpeditions.forEach(exp => {
                if (gameState.selectedExpeditionIds.includes(exp.id)) {
                    ...
                    if (gameState.currentLobbyId) {
                        import('../main.js?v=213').then(m => m.syncExpeditionToFirebase(gameState.myPlayerId, exp));
                    }
                }
            });
