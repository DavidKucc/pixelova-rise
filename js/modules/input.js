console.log('[INPUT] input.js loaded v=227');

import { ui, updateSliderLabel, logMessage, removeContextMenu } from './ui.js?v=227';
import { viewportState, gameState } from './state.js?v=227';
import * as C from './config.js?v=227';
import { gatherExpeditions, launchExpedition, redirectExpedition, initGame, handleCellClick, captureStructure, showExpeditionMenu, showBuildMenu, showCaptureMenu, splitExpedition, centerCameraOnBase } from './game.js?v=227';
import { updateUI } from './ui.js?v=227';
            ...
            player.activeExpeditions.forEach(exp => {
                if (gameState.selectedExpeditionIds.includes(exp.id)) {
                    ...
                    if (gameState.currentLobbyId) {
                        import('../main.js?v=227').then(m => m.syncExpeditionToFirebase(gameState.myPlayerId, exp));
                    }
                }
            });
