console.log('[INPUT] input.js loaded v=217');

import { ui, updateSliderLabel, logMessage, removeContextMenu } from './ui.js?v=217';
import { viewportState, gameState } from './state.js?v=217';
import * as C from './config.js?v=217';
import { gatherExpeditions, launchExpedition, redirectExpedition, initGame, handleCellClick, captureStructure, showExpeditionMenu, showBuildMenu, showCaptureMenu, splitExpedition, centerCameraOnBase } from './game.js?v=217';
import { updateUI } from './ui.js?v=217';
            ...
            player.activeExpeditions.forEach(exp => {
                if (gameState.selectedExpeditionIds.includes(exp.id)) {
                    ...
                    if (gameState.currentLobbyId) {
                        import('../main.js?v=217').then(m => m.syncExpeditionToFirebase(gameState.myPlayerId, exp));
                    }
                }
            });
