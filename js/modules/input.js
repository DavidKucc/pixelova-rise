...
console.log('[INPUT] input.js loaded v=176');

import { ui, updateSliderLabel, logMessage, removeContextMenu } from './ui.js?v=176';
import { viewportState, gameState } from './state.js?v=176';
import * as C from './config.js?v=176';
import { gatherExpeditions, launchExpedition, redirectExpedition, initGame, handleCellClick, captureStructure, showExpeditionMenu, showBuildMenu, showCaptureMenu, splitExpedition } from './game.js?v=176';
import { updateUI } from './ui.js?v=176';
