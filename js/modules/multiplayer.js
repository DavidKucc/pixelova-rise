console.log('[DEBUG] multiplayer.js loaded v=201');
...
import { gameState } from './state.js?v=201';
import { getServerTime } from './utils.js?v=201';
import { captureStructure } from './game.js?v=201';
