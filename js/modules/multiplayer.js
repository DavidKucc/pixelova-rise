console.log('[DEBUG] multiplayer.js loaded v=212');
...
import { gameState } from './state.js?v=212';
import { getServerTime } from './utils.js?v=212';
import { captureStructure } from './game.js?v=212';
