console.log('[DEBUG] multiplayer.js loaded v=202');
...
import { gameState } from './state.js?v=202';
import { getServerTime } from './utils.js?v=202';
import { captureStructure } from './game.js?v=202';
